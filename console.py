...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        if len(params) < 2:
            ...
            attr_params = params[1:]
            new_instance = self.build_with_attrs(classname, attr_params)

        print(new_instance)
        new_instance.save()
        print(new_instance.id)

    def build_with_attrs(self, classname, attr_params):
        """ Build new instance using params as attrs """
        attributes = {}
